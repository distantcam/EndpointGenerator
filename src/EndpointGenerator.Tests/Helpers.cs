...
internal static class Helpers
{
    ...
    public static async Task<CSharpCompilation> Compile(
        ...
        string assemblyName = "EndpointGeneratorTest",
        ...
        IEnumerable<MetadataReference>? extraReferences = default)
    {
        ...
        var attributeReference = MetadataReference.CreateFromFile(typeof(EndpointBuilderAttribute).Assembly.Location);
        ...
        return CSharpCompilation.Create(
            ...
            [attributeReference, .. references, .. aspnetRef, .. extraReferences],
